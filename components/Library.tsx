    ...
    <div className=" flex flex-col">
      <div className=" flex items-center justify-between px-5 pt-7 relative ">
        <div className=" mt-2 inline-flex items-center gap-x-2">
          ...
          <p className="text-neutral-400 font-medium text-md hover:text-white">Your Library</p>
        </div>
        <div className=" group ">
          <AiOutlinePlus
            onClick={onClick}
          ...
          />
          <div className=" transition opacity-0 absolute right-12 bottom-7 p-1 bg-neutral-800 text-sm rounded-md group-hover:opacity-100 shadow-md duration-500">
            Add Song
          </div>
        </div>
        <div className=" group ">
